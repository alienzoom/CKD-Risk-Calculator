# Программа для прогнозирования риска хронической болезни почек у детей
...
## 📸 Скриншоты
| Интерфейс | Пример результата |
|----------|-------------------|
| ![](screenshots/main_window.png) | ![](screenshots/low_risk.png) | ![](screenshots/high_risk.png) |
